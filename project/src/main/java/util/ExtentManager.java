...
public class ExtentManager {
	...
	static StringBuffer reportname = new StringBuffer().append(extentReport).append(time.format(formatter)).append( ".html");
	
	static String reportName =reportname.toString();
